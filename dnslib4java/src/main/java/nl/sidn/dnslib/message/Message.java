...
import nl.sidn.dnslib.message.records.NotImplementedResourceRecord;
...
public class Message {
	...
	public void updateHeaderCounters() {
		...
		if(pseudo != null) this.header.setArCount((char)(this.header.getArCount()+1));
	}
