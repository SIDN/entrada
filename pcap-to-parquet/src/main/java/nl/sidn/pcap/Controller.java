...
public class Controller {
  ...
  public Controller() {
    ...
    /*
     * create a pcap loader, reading and decoding pcap files is done by this separate thread. This
     * allows for simultaneous writing of decoded packets to parquet
     */
    startLoaderThread(
        setting.getSetting(Settings.INPUT_LOCATION) + System.getProperty("file.separator")
            + Settings.getInstance().getServer().getFullname(),
