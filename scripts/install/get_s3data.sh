...
ANALYZE TABLE $IMPALA_ICMP_DWH_TABLE PARTITION(year, month, day, server) COMPUTE STATISTICS;
ANALYZE TABLE $IMPALA_ICMP_DWH_TABLE PARTITION(year, month, day, server) COMPUTE STATISTICS for columns;
ANALYZE TABLE $IMPALA_ICMP_STAGING_TABLE PARTITION(year, month, day, server) COMPUTE STATISTICS;
ANALYZE TABLE $IMPALA_ICMP_STAGING_TABLE PARTITION(year, month, day, server) COMPUTE STATISTICS for columns;
