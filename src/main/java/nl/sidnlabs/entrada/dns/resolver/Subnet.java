...
public class Subnet {
  ...
  private Subnet(final InetAddress subnetAddress, final int bits) {
    ...
    this.bigMask = BigInteger.valueOf(-1).shiftLeft(this.bytesSubnetCount * 8 - bits); // mask = -1
                                                                                       // << 32 -
                                                                                       // bits
  ...
  private void bigInteger2IpString(final StringBuilder buf, final BigInteger bigInteger,
